...
Original file is located at
    https://colab.research.google.com/drive/17sKVKYbHMAa2m2WhxXOENUq82XuPCh3l
"""
...
x = torch.zeros(1, 3, 56, 56, requires_grad=True)
weights = {'x':x}
out = model(x)
make_dot(out)

batch = torch.zeros(1, 3, 56, 56, requires_grad=True)

input_names = ['inputs']
output_names = ['labels']
torch.onnx.export(model, batch, 'cnn.onnx', input_names=input_names, output_names=output_names)

from google.colab import files
files.download("cnn.onnx")
